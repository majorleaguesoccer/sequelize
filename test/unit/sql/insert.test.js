...
describe(Support.getTestDialectTeaser('SQL'), () => {
  ...
  describe('bulkCreate', () => {
    ...
    it('bulk create with preserveValuesOnNull', () => {
      ...
      expectsql(sql.bulkInsertQuery(User.tableName, [{ user_name: 'testuser', pass_word: '12345' }], { updateOnDuplicate: ['user_name', 'pass_word', 'created_at'], preserveValuesOnNull: ['user_name', 'pass_word', 'created_at'] }, User.rawAttributes),
        {
          default:'INSERT INTO `users` (`user_name`,`pass_word`) VALUES (\'testuser\',\'12345\');',
          postgres:'INSERT INTO "users" ("user_name","pass_word") VALUES (\'testuser\',\'12345\');',
