...
class Model {
  ...
  static bulkCreate(records, options) {
    ...
    if (options.preserveValuesOnNull) {
      ...
      let preservableFields = _.pull(Object.keys(this.tableAttributes), 'updatedAt');
      if (_.isArray(options.preserveValuesOnNull) && !_.isEmpty(options.preserveValuesOnNull)) {
        preservableFields = _.intersection(preservableFields, options.preserveValuesOnNull);
      }
